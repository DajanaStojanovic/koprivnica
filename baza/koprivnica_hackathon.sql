...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2016 at 07:17 PM
...
CREATE TABLE `event` (
  ...
  `finish_time` tinyint(4) DEFAULT NULL,
...
(35, '„Mreža plus“ – istraži korisne web stranice i alate', 'Zrinski trg 6, Koprivnica', 'Voditeljice: knjižničarke u Dječjem odjelu ', '07', '07', '2016', 127, '07', '07', '2016', NULL, NULL, NULL, 'Obrazovanje', '38.jpg', NULL),
(36, '„Mreža plus“ – istraži korisne web stranice i alate', 'Zrinski trg 6, Koprivnica', 'Voditeljice: knjižničarke u Dječjem odjelu ', '14', '07', '2016', 127, '14', '07', '2016', NULL, NULL, NULL, 'Obrazovanje', '38.jpg', NULL),
(37, '„Mreža plus“ – istraži korisne web stranice i alate', 'Zrinski trg 6, Koprivnica', 'Voditeljice: knjižničarke u Dječjem odjelu ', '21', '07', '2016', 127, '21', '07', '2016', NULL, NULL, NULL, 'Obrazovanje', '38.jpg', NULL),
(38, '„Mreža plus“ – istraži korisne web stranice i alate', 'Zrinski trg 6, Koprivnica', 'Voditeljice: knjižničarke u Dječjem odjelu ', '28', '07', '2016', 127, '28', '07', '2016', NULL, NULL, NULL, 'Obrazovanje', '38.jpg', NULL),
(39, 'Filmovi u podne', 'Zrinski trg 6, Koprivnica', 'Dječji odjel\r\n\r\nVideo projekcije prema izboru djece', '19', '07', '2016', 127, '19', '07', '2016', NULL, NULL, NULL, 'Zabava', '39.jpg', NULL),
(40, 'Program „Zdravstveni susreti pod suncobranima“', 'Zrinski trg 6, Koprivnica', 'Terasa ispred Knjižnice i čitaonice “Fran Galović” /  u slučaju lošeg vremena Čitaonica tiska\r\n\r\nTema: Kako preživjeti menopauzu?\r\n\r\nPredavač(i): Slavica Pirc, bacc. med. techn. i Ivan Pavlović, dr. med. spec. gin.', '22', '07', '2016', 127, '22', '07', '2016', NULL, NULL, NULL, 'Zdravlje', '2.jpg', NULL),
(41, 'Pričaonica za djecu predškolske dobi od 4 godine nadalje ', 'Zrinski trg 6, Koprivnica', 'Dječji odjel\r\n\r\nČitamo priču: Winnie pod morem\r\n\r\nVoditeljica: Marta Jagušić, odgajateljica', '25', '07', '2016', 127, '25', '07', '2016', 127, NULL, NULL, 'Obrazovanje', '4.jpg', NULL),
(42, 'TEDxKoprivnicaLibrary – što nam budućnost i znanost donose? ', 'Zrinski trg 6, Koprivnica', 'Dvorište Knjižnice i Kina Velebit', '26', '07', '2016', 127, '26', '07', '2016', NULL, NULL, NULL, 'Obrazovanje', '42.jpg', NULL),
(43, 'Radionica FRANCUSKOG JEZIKA za djecu od 5 do 10 godina ', 'Zrinski trg 6, Koprivnica', 'Dječji odjel\r\n\r\nVoditeljica: Irena Novak, mag. educ. francuskog jezika i književnosti i mag. etnologije i kulturne antropologije\r\n\r\nProgram JEZIČNI GLOBUS', '26', '07', '2016', 127, '26', '07', '2016', 127, NULL, NULL, 'Obrazovanje', '43.jpg', NULL),
(44, 'Program „Zdravstveni susreti pod suncobranima“', 'Zrinski trg 6, Koprivnica', 'Terasa ispred Knjižnice i čitaonice “Fran Galović” /  u slučaju lošeg vremena Čitaonica tiska\r\n\r\nTema: Kako se nositi sa stresom?\r\n\r\nPredavač(i): Mirjana Grubić Marković, dr. med. spec. psihijatrije i Tihana Kosi, prof. psihologije', '29', '07', '2016', 127, '29', '07', '2016', NULL, NULL, NULL, 'Zdravlje', '2.jpg', NULL),
(45, '2. Ljetna tržnica knjiga', 'Gradski park, Koprivnica', 'Knjižnica i čitaonica “Fran Galović” ponovno će na prodaju ponuditi otpisane knjige iz svog amortiziranog fonda, a poznati nakladnici ponudit će svoja izdanja po povoljnijoj cijeni. Dođite i ugodno provedite subotnje jutro s knjigom!', '30', '07', '2016', 127, '30', '07', '2016', 127, NULL, NULL, 'Posao', '45.jpg', NULL),
(46, 'Međunarodni festival folklora: "Iz bakine škrinje"', 'Starogradska ulica 1, Koprivnica', 'Dvorana "Domoljub"\r\n\r\nBesplatne ulaznice za 10. međunarodni festival folklora "Iz bakine škrinje" (za koncert u Domoljubu) možete podići u Domoljubu radnim danom od 7:00 do 19:00 sati.', '09', '07', '2016', 127, '09', '07', '2016', NULL, NULL, NULL, 'Kultura', '46.jpg', NULL),
(47, '‘Ready, Steady, Go!‘ - završni event ‘GO!‘', 'Ulica Hrvatske državnosti 10, Koprivnica', 'Koprivnički poduzetnik u suradnji s partnerom Udruženjem obrtnika Koprivnica provodi projekt ‘Ready, Steady, Go!‘. U sklopu projekta dosad su organizirali tri eventa, a u sklopu završnog, ‘GO!‘, koji će se održati u petak 8. srpnja organiziraju poduzetnički panel i party s grupom Blues Messenger.\r\n\r\nNa poduzetničkom panelu svoje će priče ispričati Ivana Toth iz poduzeća iTi PARTNERI i Saša Miklošić iz projekta NANODIY. Na svojem će primjeru objasniti da u privatnom poslu ne ide uvijek sve ‘ko po loju’, ali oni uporni, oni spremni pronaći pravi biznis za sebe, uvijek uspiju.\r\n\r\nBela Ikotić koordinator je projekata u Poduzetničkom inkubatoru BIOS Osijek. S prisutnima će podijeliti zanimljive priče o uspjehu, neuspjehu i upornosti s kojima se susreo radeći s poduzetnicima.', '08', '07', '2016', 127, '08', '07', '2016', NULL, NULL, NULL, 'Posao', '47.jpg', NULL),
(48, 'DJ DLAKAVI', 'Trg mladosti 18, Koprivnica', 'Najdlakaviji među PXL Crew je Dj Dlakavi :-) Ali to znači da je jedan od najkreativnijih selektora Pixela. Kaj nam ovaj puta prema, e to treba vidjeti! :-)', '09', '07', '2016', 127, '09', '07', '2016', NULL, NULL, NULL, 'Zabava', '48.jpg', NULL),
(49, 'Lego kockice u orbiti oko Jupitera', 'Trg mladosti 18, Koprivnica', 'Svemirska sonda Juno stigla je u orbitu oko najvećeg planeta Sunčeva sustava - Jupitera. Ako je pritom sve prošlo u redu, provest će tamo nešto više od godinu dana. Što će tamo raditi i što smo najnovije otkrili o kralju bogova među planetima (i zašto sa sobom nosi lego kockice) doznajte na zanimljivom predavanju Astronomskog društva Koprivnica uz izravno promatranje Jupitera teleskopom.\r\n\r\nGostuje: Astronomsko društvo Koprivnica', '14', '07', '2016', 127, '14', '07', '2016', NULL, NULL, NULL, 'Zabava', '49.jpg', NULL),
(50, 'Otvorenje izložbe Second (II)', 'Trg mladosti 18, Koprivnica', 'Second (II) je druga zajednička izložba autorica Teodore Lukavski i Nine Mataković. Ove mlade fotografkinje bave se različitim motivima: prirodom, portretima ali i interijerima, a zajednička im je ljubav prema fotografiji kao i sklonost prema eksperimentu u okvirima tog bezvremenskog medija.\r\n\r\nGostuju: Nina Mataković i Teodora Lukavski', '21', '07', '2016', 127, '21', '07', '2016', NULL, NULL, NULL, 'Kultura', '50.jpg', NULL),
